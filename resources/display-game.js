...
//;(function(exports){
    ...
    var linkList = [];
    var playerList = {}; 
    var playerColors = d3.shuffle(["#4C92C3", "#ff7f0e", "#2ca02c", "#d62728", "#e377c2", "#ffff00"]); 
    ...
    var createGraph = function (callback) {
        $.getJSON("/resources/board_graph.json", function(data) {
        ...
        d3.json("/game/" + gameID + "/1", function(data) {
            ...
            for (player in players) {
                ...
                var playerP = d3.select("#gameStats").append("p")
                    ...
                    .style("color", playerColors[playerList[player]])
...
var actionReinforced = function (currentTurn, lhs, rhs) {
    ...
    var updateNodes = function(currentTurn) {
        ...
        d3.selectAll(".node").select(".countryCircle").style("fill", function(d) {return playerColors[playerList[d.owner]]}); 
        force.start(); 
    };
